...
namespace ManejoPresupuesto.Controllers
{
    public class TransaccionesController : Controller
    {
        ...
        //Esta Accion genera el archivo excel, pasandole el nombre del archivo y los datos
        ...
        public async Task<IActionResult> Crear()
        {
            ...
            //cargara las categorias del usuario y recibiera por defecto la categorias de ingreso
            return View(modelo);
        ...
        //Obtiene las cuentas del usuario de la capa de datos
        ...
        //Obtiene las categorias del usuarios por el tipo de operacion
        private async Task<IEnumerable<SelectListItem>> ObtenerCategorias(int usuarioId, TipoOperacion tipoOperacion)
        {
            var categorias = await repositorioCategorias.Obtener(usuarioId, tipoOperacion);
            var resultado = categorias.Select(x => new SelectListItem(x.Nombre, x.Id.ToString())).ToList();

            resultado.Insert(0, new SelectListItem("-- Selecione una Categoria --", "0", true));

            return resultado;
        }


        //Obtener las categorias del usuario por el tipo de Operacion hacia el front end
        [HttpPost]
